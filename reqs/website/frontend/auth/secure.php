...
<body>
   ...
   <div class="container" id="container">
      <div class="forms-container">
         <div class="verify-reset">
            <!-- Verify Account Form -->
            <form action="/auth/verifyAccount" method="post" class="vrfy-accnt-form" id="vrfyAccountForm"
               autocomplete="off">
               ...
               <div class="otp-section">
                  ...
                  <div class="otp-container">
                     <input type="text" id="otp1" name="otp1"
                        value="<?php echo isset($_SESSION['temp_data']['otp1']) ? htmlspecialchars($_SESSION['temp_data']['otp1']) : ''; ?>"
                        class="otp-input" maxlength="1" autocomplete="off" />
                     <input type="text" id="otp2" name="otp2"
                        value="<?php echo isset($_SESSION['temp_data']['otp2']) ? htmlspecialchars($_SESSION['temp_data']['otp2']) : ''; ?>"
                        class="otp-input" maxlength="1" autocomplete="off" />
                     <input type="text" id="otp3" name="otp3"
                        value="<?php echo isset($_SESSION['temp_data']['otp3']) ? htmlspecialchars($_SESSION['temp_data']['otp3']) : ''; ?>"
                        class="otp-input" maxlength="1" autocomplete="off" />
                     <input type="text" id="otp4" name="otp4"
                        value="<?php echo isset($_SESSION['temp_data']['otp4']) ? htmlspecialchars($_SESSION['temp_data']['otp4']) : ''; ?>"
                        class="otp-input" maxlength="1" autocomplete="off" />
                     <input type="text" id="otp5" name="otp5"
                        value="<?php echo isset($_SESSION['temp_data']['otp5']) ? htmlspecialchars($_SESSION['temp_data']['otp5']) : ''; ?>"
                        class="otp-input" maxlength="1" autocomplete="off" />
                     <input type="text" id="otp6" name="otp6"
                        value="<?php echo isset($_SESSION['temp_data']['otp6']) ? htmlspecialchars($_SESSION['temp_data']['otp6']) : ''; ?>"
                        class="otp-input" maxlength="1" autocomplete="off" />
                  </div>
               </div>
               <div class="input-field">
                  <i class="fas fa-user"></i>
                  <input type="text" name="username" placeholder="Username" aria-label="Enter a unique username"
                     autocomplete="off"
               ...
               <div class="input-field">
                  ...
                  <input type="password" name="newpassword" id="newPassword" placeholder="New Password"
                     aria-label="Enter new password" autocomplete="off"
                     value="<?php echo isset($_SESSION['temp_data']['newpassword']) ? htmlspecialchars($_SESSION['temp_data']['newpassword']) : ''; ?>" />
                  <i class="fa-solid fa-eye-slash toggle-password" data-target="newPassword"></i>
               </div>
               <div class="input-field">
                  <i class="fas fa-lock"></i>
                  <input type="password" name="cnfrmpassword" id="confirmPassword" placeholder="Confirm Password"
                     aria-label="Confirm your new password" autocomplete="off"
                     value="<?php echo isset($_SESSION['temp_data']['cnfrmpassword']) ? htmlspecialchars($_SESSION['temp_data']['cnfrmpassword']) : ''; ?>" />
                  <i class="fa-solid fa-eye-slash toggle-password" data-target="confirmPassword"></i>
               </div>
               <!-- Verify Account Form -->
               <div class="link-gnrtpswrd">
                  <a href="#" id="generatePasswordVerify" class="genpswrdlink" role="button"
            ...
            <!-- Reset Password Form -->
            <form action="/auth/resetPassword" method="post" class="rst-pswrd-form" id="rstPswrdForm"
               autocomplete="off">
               ...
               <div class="input-field">
                  ...
                  <input type="password" name="newpassword" id="newPasswordReset" placeholder="New Password"
               ...
               <div class="input-field">
                  <i class="ri-lock-2-fill"></i>
                  <input type="password" name="cnfrmpassword" id="confirmPasswordReset" placeholder="Confirm Password"
                     aria-label="Confirm your new password" autocomplete="off"
                     value="<?php echo isset($_SESSION['temp_data']['cnfrmpassword']) ? htmlspecialchars($_SESSION['temp_data']['cnfrmpassword']) : ''; ?>" />
               ...
               <div class="link-gnrtpswrd">
                  <a href="#" id="generatePasswordReset" class="genpswrdlink" role="button"
                     aria-label="Generate a secure password">
                     <i class="fa-solid fa-gear"></i>
                     Generate a Secure Password
                  </a>
   ...
   <script src="/assets/js/otpHandler.js"></script>
